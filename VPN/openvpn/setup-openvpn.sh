...
cd /etc/openvpn/
wget https://github.com/lamtota40/vpn-server-easy/raw/main/VPN/openvpn/vpn.zip
unzip vpn.zip
rm -f vpn.zip
...
# puting certificate in config client TCP 1194
