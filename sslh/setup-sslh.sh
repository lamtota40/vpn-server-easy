...
[Service]
ExecStart=/usr/sbin/sslh --foreground --user sslh --listen 0.0.0.0:443 --ssh 127.0.0.1:23 --tls 127.0.0.1:955 --openvpn 127.0.0.1:995 --http 127.0.0.1:2082 --pidfile /var/run/sslh/sslh443.pid
KillMode=process
...
[Service]
ExecStart=/usr/sbin/sslh --foreground --user sslh --listen 0.0.0.0:77 --ssh 127.0.0.1:22 --tls 127.0.0.1:944 --openvpn 127.0.0.1:111 --http 127.0.0.1:8043 --pidfile /var/run/sslh/sslh77.pid
KillMode=process
